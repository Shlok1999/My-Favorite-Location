...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val userMapGenerate = generateSampleData()
        //Set Layout manager on the recycler view
        rV_maps.layoutManager = LinearLayoutManager(this)
        //Set adapter on the recycler view
        rV_maps.adapter = MapsAdapter(this, userMapGenerate, object : MapsAdapter.OnClickListener{
        ...
        //When user taps an item view, we shoud go to another activity
